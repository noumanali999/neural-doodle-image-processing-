#This is only for university purpose
#this assignment made by group
#2k18/ite/82
#2k18/ite/118
...
import itertools
import collections
parser = argparse.ArgumentParser(description='Its Generating the new image of in another effect.',
